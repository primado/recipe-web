            ...
            <section className="px-28 py-16 bg-white-f8 w-full min-h-screen">
                <div className="flex flex-col gap-y-5">
                    <div className="flex flex-col gap-y-4 w-[70%]">
                        <h1 className="text-black break-words text-5xl font-bold">Lorem ipsum dolor sit amet.</h1>
                        <p className="text-black text-xl font-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem officia adipisci eum. Nam, sunt aperiam eligendi nesciunt tempora laboriosam repellendus.</p>
                    </div>
                    <div className="">
                        <Image 
                    ...
                    <div className="">
                        <h4 className="text-black text-lg font-medium">Total Time</h4>
